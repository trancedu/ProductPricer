...
public:
    ...
    double commonBondFunction(const BondData* bond) const {
...
public:
    ...
    double calculatePrice(const CallableBondData* bond) const {
...
public:
    ...
    double calculatePrice(const ConvertibleBondData* bond) const {
        double base_price = bond->bond_specific_value * 1.05;
